...
public class KAECurveDB {
    ...
    public static Collection<? extends KAENamedCurve>getSupportedCurves() {
        return specCollection;
    }

    // Return a NamedCurve for the specified OID/name or null if unknown.
    static KAENamedCurve lookup(String name) {
    ...
    static KAENamedCurve lookup(ECParameterSpec params) {
    ...
    private static void add(String name, String soid, int type, String sfield,
        ...
        KAENamedCurve params = new KAENamedCurve(name, soid, curve, g, bi(n), h);
    ...
    static String[] getNamesByOID(String oid) {
        KAENamedCurve nc = oidMap.get(oid);
        if (nc == null) {
            return new String[0];
        }
